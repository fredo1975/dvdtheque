...
public class TmdbServiceImpl implements TmdbService{
	...
	protected Logger logger = LoggerFactory.getLogger(TmdbServiceImpl.class);
	...
	public TmdbServiceImpl(RestTemplateBuilder restTemplateBuilder) {
	 ...
	 *
	@Override
	public Results replaceFilm(final Long tmdbId) throws Exception {
		Boolean isTmdbFilmExists = restTemplate.getForObject(environment.getRequiredProperty(TMDB_MOVIE_QUERY)+tmdbId, Boolean.class);
		if(isTmdbFilmExists) {
		...
		return retrieveTmdbSearchResultsById(tmdbId);
